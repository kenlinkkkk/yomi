...
class Convert
{
	public function convertDate($date, $month, $year, $time_zone = 7)
	{
		return $this->convertSolar2Lunar($date, $month, $year, $time_zone);
	}

	public function convertSolarToLunar($date, $month, $year, $leap, $time_zone)
	{
		return $this->convertLunar2Solar($date, $month, $year, $leap, $time_zone);
	}

//	convert date to Julius date
...
//	convert Julius date to day/mon/year
...
//	tính ngày Sóc (ngày trái đất, mặt trăng, mặt trời cùng đường thẳng)
...
//	fuction tinh ngay bat dau thang 11 am lich
...
//	function convert ngay duong sang am
	private function convertSolar2Lunar($dd, $mm, $yy, $timeZone)
	{
		...
		return array('day' => $lunarDay, 'month' => $lunarMonth, 'year' => $lunarYear, 'leap' => $lunarLeap);
	}

//	function convert ngay am sang ngay duong
