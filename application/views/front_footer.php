            ...
            <div class="container vh-center white-text">
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4">
                        <img src="<?=base_url('assets/images/logo.png')?>" class="logo-footer-mobile">
                ...
                <div class="row footer-ul hidden-div">
                    ...
                    <ul>
                        <li>
                            <span><img src="<?= base_url('assets/images/icons/address.png')?>" class="vh-center" style="max-width: 30px; max-height: 30px;"></span>
