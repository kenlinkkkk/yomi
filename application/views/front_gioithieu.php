...
<main>
    <div id="gioithieu">
        <div class="w-100">
            <img src="<?=base_url('assets/images/banners/gioithieu.png')?>" class="img-fit">
        </div>
                ...
                <div class="col-10 vh-center">
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-2">
                            <center>
                                <img src="<?= base_url('assets/images/stickers/2.png')?>" class="img-fit vh-center">
                            </center>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-md-2">
                            <center>
                                <img src="<?= base_url('assets/images/stickers/1.png')?>" class="img-fit vh-center">
                            </center>
                        </div>
                    </div>
                </div>
